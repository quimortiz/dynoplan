...
void export_final_solution(dynobench::Trajectory &trajectory, std::ofstream *out){
...
int main(int argc, char* argv[]) {
    ...
    desc.add_options()
      ...
      ("constraints,cnst", po::value<std::string>(&constraintsFile), "constraints file (yaml)")
    ...
    tdbastar(problem, options_tdbastar, trajectory, constraints,
            out_tdb, robot_id,/*reverse_search*/false, expanded_trajs_tmp, nullptr, nullptr);
