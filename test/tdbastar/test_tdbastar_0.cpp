...
BOOST_AUTO_TEST_CASE(test_eval_multiple) {
  ...
  std::vector<Problem> problems{
      DYNOBENCH_BASE "envs/unicycle1_v0/swap/swap2_unicycle.yaml",
      DYNOBENCH_BASE "envs/unicycle2_v0/swap/swap2_unicycle2.yaml",
      DYNOBENCH_BASE "envs/integrator2_2d_v0/swap/swap2_double_integrator.yaml",
      DYNOBENCH_BASE "envs/car1_v0/swap/swap2_trailer.yaml"};
