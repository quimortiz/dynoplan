...
// Original file :
// https://github.com/loco-3d/crocoddyl/blob/devel/unittest/factory/state.cpp
//
...
const std::vector<StateModelTypes::Type>
    StateModelTypes::all(StateModelTypes::init_all());
...
StateModelFactory::create(StateModelTypes::Type state_type) const {
