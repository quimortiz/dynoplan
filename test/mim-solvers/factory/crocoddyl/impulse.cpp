...
// Original file :
// https://github.com/loco-3d/crocoddyl/blob/devel/unittest/factory/impulse.cpp
//
...
const std::vector<ImpulseModelTypes::Type>
    ImpulseModelTypes::all(ImpulseModelTypes::init_all());
...
ImpulseModelFactory::create(ImpulseModelTypes::Type impulse_type,
